"""Pure decision and schedule primitives for the E5-v2 routed campaign."""
...
class Policy(str, Enum):
    """Resolver/IPS policies used by E5-v2."""
...
def make_complete_block(rep: int, seed: int) -> list[BlockCell]:
    """Return one seeded randomized complete block of 4 policies x 4 workloads."""

    cells = [
        BlockCell(policy=policy.value, workload=workload)
        for policy in CONFIRMATORY_POLICIES
