#!/usr/bin/env python3
"""Prospectively registered E5 supplement; previous code and results are read-only."""
...
def source_files() -> dict[str, Path]:
    ...
    files["analysis/e5_aggregate.py"] = E5 / "e5_aggregate.py"
    return files
