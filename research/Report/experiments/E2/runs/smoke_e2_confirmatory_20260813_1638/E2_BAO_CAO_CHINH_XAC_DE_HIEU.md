...
- Có 20 lần chạy độc lập cho mỗi ô kết quả chính (test), mỗi lần 30 lần chấm điểm.
...
- Mỗi run giữ raw JSONL: event FRAG2, IPID, origin, timestamp, feature và quyết định B1–B5. Validator đã đọc lại toàn bộ raw và tính lại các số trong bảng.
...
|---:|---:|---:|---:|---:|---:|
| 24 | 0.505 | 0.505 | 0.505 | 0.505 | 0.000 [0.000, 0.000] |
...
| Tải | B2: benign bị bật | B2: condition attack bị bật | B5: benign bị bật | B5: condition attack bị bật | ΔJ (B5−B2), 95% CI |
|---:|---:|---:|---:|---:|---:|
| 24 | 0.465 | 0.465 | 0.465 | 0.465 | 0.000 [0.000, 0.000] |
| 60 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 [0.000, 0.000] |
| 120 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 [0.000, 0.000] |
| 200 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 [0.000, 0.000] |
...
- Nếu B5 bằng B2 trong nhiều ô, kết quả đúng là: entropy và unique ratio chưa đóng góp thêm ở những regime đó. Đó là một kết quả nghiên cứu hữu ích, không phải lỗi cần che đi.
