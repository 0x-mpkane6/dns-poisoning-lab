...
The same paired data also report all B1–B5 ablations and B5's paired effect
...
BASELINE_VARIANTS = tuple(variant for variant in VARIANTS if variant != "combined")
